package ru.mirea.kovalev.stonks;
...
public class StonksClient {
    public static void main(String[] args) throws IOException, SQLException {
        ...
        Response<DailyCurs> response = stonksService
                .getDailyCurs(LocalDate.of(2004, 11, 4)
        ...
        if(maxValute.isPresent()) {
            ...
            databaseService.saveMaxValuteOfDate("KovalevMV", mv, LocalDate.of(2004, 11, 4));
        }
        Valute valute = databaseService.getValuteOfDate(LocalDate.of(2004, 11, 4));
    }
}
